        ...
        tools: [
            {
                ...
                description: "Design a multi-step Autodesk automation pipeline as a DAG (fetch/transform/export/notify/trigger across Revit, ACC, APS, Model Derivative, etc.). " +
            ...
            },
            {
                ...
                description: "Run an APS capability: Engine-API (DA WorkItem → polls → outputOssUrl) or Platform-API (REST call → response). " +
            ...
            {
                name: "process_file",
                description: "Execute a complete Autodesk file workflow in one call: auto-selects capability from file type + intent, uploads, runs the DA WorkItem or REST operation, and returns all output content. " +
            ...
            case "create_workflow": {
                ...
                return {
                    content: [
                        ...
                        { type: "text", text: JSON.stringify(dag, null, 2) },
                    ],
                };
            }
